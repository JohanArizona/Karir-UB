<nav x-data="{ open: false }">
    ...
    <nav class="sticky top-0 z-50 flex justify-between items-center p-4 bg-white shadow max-w-full mx-auto">
        ...
        <div class="flex space-x-4">
            <a href="#" class="font-semibold px-12 py-2 text-[#003759] rounded-full border-2 border-[#003759]">Login</a>
            <a href="#" class="px-12 py-2 bg-[#003759] text-white rounded-full">Register</a>
        </div>
    </nav>
